    ...
    <div className="flex items-center">
      ...
      <div className="relative" ref={dropdownRef}>
        <button 
          ...
          className="flex items-center space-x-2 bg-blue-100 hover:bg-blue-200 rounded-full py-1 px-4 transition-colors border border-blue-300"
        >
        ...
        {/* Dropdown Menu */}
        <div className={`absolute right-0 mt-2 w-64 bg-white rounded-lg shadow-lg z-20 border border-gray-100 origin-top-right transition-transform duration-200 ${isOpen ? 'scale-100' : 'scale-0'}`}>
