  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      setComplaints([
        {
          id: 1,
          equbName: "Weekly Savers",
          userName: "Tigist Haile",
          message:
            "Payment not registered correctly. I made the payment on Monday but it's still showing as unpaid in the system.",
          status: "Pending",
          dateSubmitted: "2025-03-20",
        },
        {
          id: 2,
          equbName: "Monthly Investors",
          userName: "Daniel Bekele",
          message:
            "Winner announcement delayed for this month's cycle. It's already been a week past the scheduled date.",
          status: "Resolved",
        ...
        },
        {
          ...
          message:
            "Unable to view past payments in my account history. The payment records for February are missing.",
          status: "Pending",
          dateSubmitted: "2025-03-22",
        },
        {
          id: 4,
          equbName: "Family Savings",
          userName: "Selam Alemu",
          message:
            "The system incorrectly calculated my contribution amount. It should be 2000 Birr but it's showing 2500 Birr.",
          status: "Pending",
          dateSubmitted: "2025-03-23",
        },
        {
          id: 5,
          equbName: "Business Group",
          userName: "Yonas Tadesse",
          message:
            "My profile information is incorrect. My phone number needs to be updated.",
          status: "Resolved",
      ...
      setNotifications([
        {
          id: 1,
          message: "New user registered: Selam Alemu",
          time: "2 hours ago",
        },
        {
          id: 2,
          message: "New complaint submitted from Tigist Haile",
          time: "1 day ago",
        },
        {
          id: 3,
          message: "Equb cycle completed: Weekly Savers",
          time: "3 days ago",
        },
